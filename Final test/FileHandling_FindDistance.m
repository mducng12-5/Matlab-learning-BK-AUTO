function [Matrix_GPS_Longtitude_1, Matrix_GPS_Lattitude_1, Matrix_GPS_Longtitude_2, Matrix_GPS_Lattitude_2] = FileHandling_FindDistance()
    ...
    Matrix_GPS_Lattitude_1 =  [data_table_1.CSMOTA_Latitude];
    Matrix_GPS_Longtitude_1 = [data_table_1.CSMOTA_Longitude];
    Matrix_GPS_Lattitude_2 =  [data_table_2.CSMOTA_Latitude];
    Matrix_GPS_Longtitude_2 = [data_table_2.CSMOTA_Longitude];
end